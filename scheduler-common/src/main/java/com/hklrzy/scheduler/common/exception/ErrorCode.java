...
public class ErrorCode {
    ...
    public static final ErrorCode ZK_NODE_FIND_EXCEPTION = ErrorCode.create(4, "创建zk节点异常");
    public static final ErrorCode PARAMETER_INVAILED_EXCEPTION = ErrorCode.create(5, "参数不合法");
    public static final ErrorCode LEADER_ELECTION_EXCEPTION = ErrorCode.create(6, "选举异常");
